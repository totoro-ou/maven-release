/*
 * File Name: ZkVersionInfo
 * Created by oujunxiao on 2018/5/28 下午3:39.
 ...
 * @version v1.0
 */
public class ZkVersionInfo implements VersionInfo {
     ...
     * @param version
     */
    public ZkVersionInfo( String version )
    ...
    public ZkVersionInfo( List<String> digits, String annotation, String annotationRevision, String buildSpecifier,
    ...
    public VersionInfo getNextVersion()
    {
        ...
        if ( digits != null )
        {
            ...
            version = new ZkVersionInfo( digits, annotation, annotationRevision, buildSpecifier,
    ...
    /**
     * Compares this {@link ZkVersionInfo} to the supplied {@link ZkVersionInfo} to determine which version is
     * greater.
     *
    ...
    {
        ZkVersionInfo that = (ZkVersionInfo) obj;
    ...
    {
        if ( !( obj instanceof ZkVersionInfo ) )
        {
            return false;
        }
    ...
    @Override
    public String getSnapshotVersionString(String mailstone)
    {
    ...
    @Override
    public String getReleaseVersionString(String mailstone)
    {
    ...
    protected static String getVersionString( ZkVersionInfo info, String buildSpecifier, String buildSeparator )
    {
