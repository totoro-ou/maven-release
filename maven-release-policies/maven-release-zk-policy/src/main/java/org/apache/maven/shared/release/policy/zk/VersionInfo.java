 ...
 * Created by oujunxiao on 2018/5/28 下午3:34.
...
public interface VersionInfo extends Comparable<VersionInfo> {
     ...
     * @param mailstone mailstone
     * @return the snapshot version transformation of the original value
     */
    String getSnapshotVersionString(String mailstone);
     ...
     */
    String getReleaseVersionString(String mailstone);
